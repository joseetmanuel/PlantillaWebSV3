...
@Component({
  selector: 'app-ins-proveedor-propio-entidad',
  templateUrl: './ins-proveedor-propio-entidad.component.html'
})
export class InsProveedorPropioEntidadComponent extends FormularioDinamico implements OnInit, OnDestroy {
  ...
  claveModulo = 'app-ins-proveedor-propio-entidad';
  modulo: any = {};
  ...
  ngOnInit() {
    ...
    this.subsNegocio = this.getStateNegocio.subscribe((stateNegocio) => {
      ...
      this.getStateAuth.subscribe((stateAutenticacion) => {
        if (stateAutenticacion.seguridad) {
          ...
          this.modulo = Negocio.GetModulo(
            this.claveModulo, stateAutenticacion.seguridad.permissions.modules, this.dataUsuario.idClase);
   ...
   // ********* Se llena arreglo con las extensiones de los archivos que se podran cargar **************************
    ...
    this.IUploadFile = {
      ...
      idModuloSeguridad: this.dataUsuario.idModuloSeguridad, multiple: true, soloProcesar: false
      , extension: ext, previsualizacion: true, tipodecarga: 'instantly'
    };
   ...
   * @param rfcProveedor RFC del proveedor.
   * @author Andres Farias
   */
        ...
        .subscribe(
          (res: any) => {
            ...
            if (res.err) {
              ...
              this.router.navigateByUrl('/upd-proveedor-propio/' + this.rfcProveedor);
            }
          },
          (error: any) => {
  ...
  /**
   * @description Recupera el resultado del fileUpload.
   * @param $event Contiene el detalle del resultado al subir los acrhivos.
   *  @param index Indice del array los inputs de tipo fileUpload.
   * @author Andres Farias
   */
    ...
    try {
      const dialogRef = this.dialog.open(ExcepcionComponent, {
        ...
        data: {
          ...
          idOperacion: 1,
          idAplicacion: 1,
          moduloExcepcion: 'ins-proveedor-propio-entidad.component',
          mensajeExcepcion: '',
          stack
        }
      });
