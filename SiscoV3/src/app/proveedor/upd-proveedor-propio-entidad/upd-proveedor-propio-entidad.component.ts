...
import { IFileUpload, IColumns, IExportExcel, ISearchPanel, IScroll, Toolbar, IColumnHiding,
  ICheckbox, IEditing, IColumnchooser } from 'src/app/interfaces';
...
@Component({
  selector: 'app-upd-proveedor-propio-entidad',
  templateUrl: './upd-proveedor-propio-entidad.component.html'
})
export class UpdProveedorPropioEntidadComponent extends FormularioDinamico implements OnInit, OnDestroy {
  ...
  claveModulo = 'app-upd-proveedor-propio-entidad';
  idClase = '';
  modulo: any = {};
   ...
   * @param $event Detalle del documentos cargado en el file upload.
   * @param index indice del formulario dinamico.
   * @author Andres Farias
   */
