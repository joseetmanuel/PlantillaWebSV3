...
@Component({
  selector: 'app-upd-proveedor-propio',
  templateUrl: './upd-proveedor-propio.component.html'
})
export class UpdProveedorPropioComponent implements OnInit, OnDestroy {
  ...
  claveModulo = 'app-upd-proveedor-propio';
  idClase = '';
  modulo: any = {};
   ...
   * @param rfcProveedor RFC del proveedor para recuperarel detalle del proveedor.
   * @author Andres Farias
   */
   ...
   * @param $event Evento con los nuevos valores del proveedor.
   * @author Andres Farias
   */
   ...
   * @param rfcProveedor RFC del proveedor para buscar sus entidades.
   * @author Andres Farias
   */
   ...
   * @param $event Eventos del los botones del data grid.
   * @author Andres Farias
   */
  ...
  ToolbarButtonEvent($event) {
    switch ($event) {
      case BUTTONS_TOOLBAR.AGREGAR:
        this.router.navigateByUrl('/ins-proveedor-propio-entidad/' + this.rfcProveedor);
        break;
      case BUTTONS_TOOLBAR.EDITAR:
        try {
          this.router.navigateByUrl(
            '/upd-proveedor-propio-entidad/' + this.datosevent[0].idProveedorEntidad
          );
        } catch (error) {
